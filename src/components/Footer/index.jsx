    ...
    <FooterWrapper>
      ...
      <div className='footer__top '>
        ...
        <div className="footer__top--left">
          <ul className='footer__top--left-list'>
            {/* #1 */}
            <li className='footer__top--left-item'>
              <h4 className='footer__top--left-heading'>Biz haqimizda</h4>
            ...
            {/* #2 */}
            <li className='footer__top--left-item'>
              <h4 className='footer__top--left-heading'>Tadbirkorlarga</h4>
        ...
        <div className="footer__top--right">
          {/* RIGHT TOP START */}
          <h4 className='footer__top--right-heading'>Ilovani yuklab olish</h4>

          <div className="footer__top--right-top">
              {/* FOOTER TOP RIGHT TOP START */}
            <div className='footer__top--right-top--wrapper'>
              ...
              <a href="https://play.google.com/store/apps/details?id=uz.uzum.app&pli=1" target='_blank'>
                Google Play
              </a>
            </div>
              {/* FOOTER TOP RIGHT TOP END */}


              {/* FOOTER TOP RIGHT BOTTOM START */}
      ...
      <div className='footer__bottom'>
        ...
        <div className="footer__bottom--left">
          <h4>
              <a href="https://legal.uzum.uz/privacy-policy-uz.html" target='_blank'>
                    Maxfiylik kelishuvi
              </a>
          </h4>

          <h4>
              <a href="https://legal.uzum.uz/user-agreement-uz.html" target='_blank'>
        ...
        <div className="footer__bottom--right">
          <blockquote cite='https://uzum.uz/uz'>
             <p>«{new Date().getFullYear()}© XK MCHJ «UZUM MARKET». STIR 309376127. Barcha huquqlar himoyalangan»</p>
          </blockquote>
        </div>
      </div>
